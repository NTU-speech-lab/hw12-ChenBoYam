...
Original file is located at
    https://colab.research.google.com/drive/1023Bkh3OvbZ94rIX2WglSC9_xA1F1cq5
...
# s_images, s_tags = torch.cat(s_images)[:num_of_samples], torch.cat(s_tags)[:num_of_samples]
# t_images, t_tags = torch.cat(t_images)[:num_of_samples], torch.cat(t_tags)[:num_of_samples]
...
#     #plt.savefig('doassfae.png')
#     #plt.show()



# plot_embedding(dann_tsne, np.concatenate((s_tags, t_tags)), 'Domain Adaptation', 'imgName')
